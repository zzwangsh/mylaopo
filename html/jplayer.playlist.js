...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			var listItem = "<li><div class='ms-icon'><i class='fa fa-heart-o'></i></div><div class='ms-ct'>";
			...
			listItem += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + media.title + (media.artist ? " <span class='jp-artist'> - " + media.artist + "</span>" : "") + "</a><i class='fa fa-volume-up'></i>";
//            listItem += "<a href='javascript:;' class='jp-play' tabindex='1' title='max volume'></a>";
			listItem += "</div></li>";
...
//                $(this.cssSelector.playlist).find('.jp-playlist-current a').remove('.plpa');
//                var $plpa = jQuery('.plpa');
//                $('.plpa').remove();
				$(this.cssSelector.playlist + " .jp-playlist-current").removeClass("jp-playlist-current");
				$(this.cssSelector.playlist + " li:nth-child(" + (index + 1) + ")").addClass("jp-playlist-current").find(".jp-playlist-item").addClass("jp-playlist-current");
//                $('.jp-playlist-current a').append($plpa);
